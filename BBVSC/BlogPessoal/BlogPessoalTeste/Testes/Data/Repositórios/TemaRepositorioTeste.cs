...
namespace BlogPessoalTeste.Testes.Data.Repositórios
{
   
        [TestClass]
    public class TemaRepositórioTeste
    {
       ...
       [TestMethod]
        public async Task CriarQuatroTemasNoBancoRetornaQuatroTemas2()
        {
            ...
            var temas =  _repositorio.PegarTodosTemas();
        ...
        public async Task AlterarTemaPythonRetornaTemaCobol()
        {
            ...
            await _repositorio.AtualizarTemaAsync(new AtualizarTemaDTO(1,
            "COBOL"));
            var tema = await _repositorio.PegarTemaPeloIdAsync(1);
